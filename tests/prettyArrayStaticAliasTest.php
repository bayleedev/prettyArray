...
/*
	...
	This all goes through the same method PrettyArray::__callStatic so only a handfull of items will be tested.

*/
class prettyArrayStaticAliasTest extends PHPUnit_Framework_TestCase {

	public function test_array_slice() {
		// Normal value
		$animals = array('ant', 'bear', 'cat');
		$animals = PrettyArray::array_slice($animals, 1);
	...
	public function test_drop() {
		// Normal value
		$animals = array('ant', 'bear', 'cat');
		$animals = PrettyArray::drop($animals, 1);
		$this->assertEquals($animals, array('bear', 'cat'));
	}
	...
	public function test_keep_if() {
		// Basic
		$arr = range(1,10);
		$arr = PrettyArray::keep_if($arr,function($key, $value) {
			return ($value % 3 == 0);
		});
		$this->assertEquals($arr, array(2=>3, 5=>6, 8=>9));
	}
	...
	public function test_select() {
		// Basic
		$arr = range(1,10);
		$arr = PrettyArray::select($arr,function($key, $value) {
			return ($value % 3 == 0);
		});
		$this->assertEquals($arr, array(2=>3, 5=>6, 8=>9));
	}
	...
	public function test_reduce() {
		$arr = range(5, 10);
		$ret = PrettyArray::reduce($arr, function($key, &$value, &$memo){
			$memo += $value;
			return;
		}); // 45
	...
	public function test_inject() {
		$arr = range(5, 10);
		$ret = PrettyArray::inject($arr, function($key, &$value, &$memo){
			$memo += $value;
			return;
		}); // 45
		$this->assertEquals($ret, 45);
	...
	public function test_include() {
		...
		$ret = PrettyArray::$fun($arr, 'snowcone'); // true
	...
	public function test_flat_map() {
		...
		$arr = PrettyArray::flat_map($arr, function($key, &$value) {
			return ++$value;
		});
	...
	public function test_collect_concat() {
		// Basic test
		$arr = array(array(1,2), array(3,4));
		$arr = PrettyArray::collect_concat($arr, function($key, &$value) {
			return ++$value;
		});
		$this->assertEquals($arr, array(2,3,4,5));
	}
	...
	public function test_take() {
		...
		$animals = PrettyArray::take($animals);
	...
	public function test_first() {
		// Test without $count
		$animals = array('cat', 'dog', 'cow', 'pig');
		$animals = PrettyArray::first($animals);
		$this->assertEquals($animals, array('cat'));
	}
	...
	public function test_find() {
		// Callback 1
		$arr = range(1,10);
		$ret = PrettyArray::find($arr, function($key, $value) {
	...
	public function test_detect() {
		// Callback 1
		$arr = range(1,10);
		$ret = PrettyArray::detect($arr, function($key, $value) {
			return ($value % 5 == 0 and $value % 7 == 0);
		});
		$this->assertEquals($ret, null);
	}
	...
	public function test_array_walk() {
		// Editing 1
		$arr = range(1,4);
		$arr = PrettyArray::array_walk($arr, function($key, &$value) {
			$value *= $value;
			return;
		});
	...
	public function test_each() {
		// Editing 1
		$arr = range(1,4);
		$arr = PrettyArray::each($arr, function($key, &$value) {
			$value *= $value;
			return;
		});
		$this->assertEquals($arr, array(1, 4, 9, 16));
	...
	public function test_map() {
		// Editing 1
		$arr = range(1,4);
		$arr = PrettyArray::map($arr, function($key, &$value) {
			$value *= $value;
			return;
		});
		$this->assertEquals($arr, array(1, 4, 9, 16));
	...
	public function test_foreach() {
		...
		$fun = 'foreach';
		$arr = range(1,4);
		$arr = PrettyArray::$fun($arr, function($key, &$value) {
			$value *= $value;
			return;
		});
		$this->assertEquals($arr, array(1, 4, 9, 16));
	...
	public function test_each_with_index() {
		// Editing 1
		$arr = range(1,4);
		$arr = PrettyArray::each_with_index($arr, function($key, &$value) {
			$value *= $value;
			return;
		});
		$this->assertEquals($arr, array(1, 4, 9, 16));
	...
	public function test_collect() {
		// Editing 1
		$arr = range(1,4);
		$arr = PrettyArray::collect($arr, function($key, &$value) {
			$value *= $value;
			return;
		});
		$this->assertEquals($arr, array(1, 4, 9, 16));
	...
	public function test_reverse_map() {
		$arr = array(1, 2, 3);
		$index = 2;
		$arr2 = PrettyArray::reverse_map($arr, function($key, &$value) {
			$value = 'cat';
			return;
		});
	...
	public function test_reverse_foreach() {
		$arr = array(1, 2, 3);
		$index = 2;
		$arr2 = PrettyArray::reverse_foreach($arr, function($key, &$value) {
			$value = 'cat';
			return;
		});
		$this->assertEquals($arr, array(1, 2, 3));
	...
	public function test_reverse_each_with_index() {
		$arr = array(1, 2, 3);
		$index = 2;
		$arr2 = PrettyArray::reverse_each_with_index($arr, function($key, &$value) {
			$value = 'cat';
			return;
		});
		$this->assertEquals($arr, array(1, 2, 3));
	...
	public function test_reverse_collect() {
		$arr = array(1, 2, 3);
		$index = 2;
		$arr2 = PrettyArray::reverse_collect($arr, function($key, &$value) {
			$value = 'cat';
			return;
		});
		$this->assertEquals($arr, array(1, 2, 3));
	...
	public function test_concat() {
		...
		$trees = array('pine');
		$material = array('wool');
		$arr = PrettyArray::concat($arr, $animals, $trees, $material);
	...
	public function test_merge() {
		...
		$trees = array('pine');
		$material = array('wool');
		$arr = PrettyArray::merge($arr, $animals, $trees, $material);
		$this->assertEquals($arr, array('dog', 'cat', 'pig', 'pine', 'wool'));
	}

	public function test_sample() {
		$arr = array('pig', 'cow', 'dog', 'horse');
		$arr = PrettyArray::sample($arr);
	...
	public function test_usort() {
		...
		$arr =PrettyArray::usort($arr, function($val1, $val2) {
	...
	public function test_sort() {
		$arr = array('rhea', 'kea', 'flea');
		$arr =PrettyArray::sort($arr, function($val1, $val2) {
			return strcmp($val2, $val1);
		});
		$this->assertEquals($arr, array('rhea', 'kea', 'flea'));
	}
	...
	public function test_delete_if() {
		$arr = range(1,10);
		$arr = PrettyArray::delete_if($arr, function($key, $value) {
			return ($value % 3 == 0);
		}); // [1, 2, 4, 5, 7, 8, 10]
	...
	public function test_reject() {
		$arr = range(1,10);
		$arr = PrettyArray::reject($arr, function($key, $value) {
			return ($value % 3 == 0);
		}); // [1, 2, 4, 5, 7, 8, 10]
		$this->assertEquals($arr, array(0=>1,1=>2,3=>4,4=>5,6=>7,7=>8,9=>10));
	}
	...
	public function test_find_index() {
		...
		$ret = PrettyArray::find_index($name, 'John');
	...
	public function test_all() {
		// Callback testing
		$animals = array('ant', 'bear', 'cat');
		$ret = PrettyArray::all($animals, function($key, $value) {
	...
	public function test_each_slice() {
		// Basic
		$arr = range(1,10);
		$arr = PrettyArray::each_slice($arr, 3, function(&$collection) {
	...
	public function test_grep() {
		...
		$arr = array('snowball', 'snowcone', 'snowangel', 'igloo', 'ice');
		$arr = PrettyArray::grep($arr, "/^snow/", function($key, &$value) {
			$value .= '_';
			return;
		});
	...
	public function test_group_by() {
		// Basic test
		$arr = range(1,6);
		$arr =PrettyArray::group_by($arr, function($key, &$value) {
			return ($value % 3);
		});
	...
	public function test_partition() {
		$arr = range(1,6);
		$arr = PrettyArray::partition($arr, function($key, $value) {
			return ($value % 2 == 0);
		});
	...
	public function test_sort_by() {
		$arr = array('rhea', 'kea', 'flea');
		$arr = PrettyArray::sort_by($arr, function($val) {
			return strlen($val);
		});
	...
	public function test_take_while() {
		...
		$arr = PrettyArray::take_while($arr, function($key, &$value) {
			return ($value < 3);
		});
	...
	public function test_zip() {
		$arr = array(1,2);
		$arr = PrettyArray::zip($arr, array(4,5,6),array(7,8,9));
		$this->assertEquals($arr, array(array(1, 4, 7), array(2, 5, 8)));
	}

	public function test_drop_while() {
		$arr = array(1,2,3,4,5,0);
		$arr = PrettyArray::drop_while($arr, function($key, &$value) {
			return ($value < 3);
		});
	...
	public function test_each_cons() {
		...
		$follower = 0;
		$message = '';
		$arr = PrettyArray::each_cons($arr, 3, function($key, $value, $leader) use (&$follower, &$message) {
			if($follower < $leader) {
				$message .= '||';
				$follower = $leader;
			}
	...
	public function test_slice_before() {
		...
		$arr = PrettyArray::slice_before($arr, "/[02468]/");
	...
	public function test_rotate_2() {
		...
		$arr = PrettyArray::rotate($arr, -1); // foobar, Foo, bar
		$this->assertEquals($arr, array('foobar', 'Foo', 'bar'));
	}

	public function test_reverse() {
		$arr = array(1,2,3);
		$arr = PrettyArray::reverse($arr);
	...
	public function test_values_at_1() {
		...
		$name = PrettyArray::values_at($name, 'title', 'last'); // ['title' => 'Dr.', 'last' => 'Doe'];
	...
	public function test_shuffle_2() {
		...
		$arr = PrettyArray::shuffle($arr, true);
	...
	public function test_cycle_1() {
		$i = 0;
		$arr = array(1,2,3);
		$arr = PrettyArray::cycle($arr, 3, function($key, $value, $it) use(&$i) {
			$i++;
		});
